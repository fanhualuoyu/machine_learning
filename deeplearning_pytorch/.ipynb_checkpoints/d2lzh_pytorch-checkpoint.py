...
def evalute_accuracy(data_iter, net, device=None): # 计算准确率
...
def load_data_fashion_mnist(batch_size, resize=None, root=r'D:\web\python\deeplearning_pytorch\Datasets/FashionMNIST'):
    trans = []
    if resize:
